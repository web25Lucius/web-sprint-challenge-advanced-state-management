...
1. What problem does the context API help solve? I no longer have to prop drill to get to a cousin component.  Use provider/consumer to access state where you need it.  
...
defining what the funciton will do
reducers - switch case actions that direct the next state/action
store - you access state from here 

3. What is the difference between Application state and Component state? When would be a good time to use one over the other?
Application state is global.  If you have something that will scale, or need access is many components.  Component state- props or context API is useful if only a few components need access to state.

4. Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?
redux thunk allows async actions in redux.  It can add functions, change functions, and generally manipulate any action.  

5. What is your favorite state management system you've learned and this sprint? Please explain why!
I like them all.  They each have their place given the circumstance.  
Redux came most easily to me.  In the end my favorite in this situation can be bought.  
